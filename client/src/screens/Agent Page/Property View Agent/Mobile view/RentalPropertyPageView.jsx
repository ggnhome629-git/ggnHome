    ...
    async function fetchProperty() {
      try {
        const response = await fetch(
          `${process.env.REACT_APP_RENTAL_PROPERTY_DETAIL_API}/${id}`,
          {
            credentials: "include",
            headers: {
              ...(agentToken ? { Authorization: `Bearer ${agentToken}` } : {}),
  ...
  if (!property) {
    return (
      ...
      >
        ...
        >
          <div style={{ fontSize: "18px", color: "#4A6A8A", fontWeight: 600 }}>
            This property is not active or has been removed by the owner.
          </div>
        </div>
      </div>
    );
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: "14px", color: "#4A6A8A" }}>
                    {property.totalArea && property.totalArea.configuration
              ...
              <div style={{ marginTop: "24px" }}>
                ...
                {property.conditionAge && (
                  ...
                  >
                    ...
                    <div style={{ fontSize: "15px", color: "#333333" }}>
                      {property.conditionAge} years old
                    </div>
                  </div>
                )}
                ...
                {property.renovations && (
                  ...
                  >
                    ...
                    <div style={{ fontSize: "15px", color: "#333333" }}>
                      {Array.isArray(property.renovations)
                        ? property.renovations.join(", ")
                        : property.renovations}
                    </div>
                  </div>
                )}
            ...
            >
              ...
              {property.otherFees && (
                ...
                >
                  ...
                  <div style={{ fontSize: "15px", color: "#333333" }}>
                    {Array.isArray(property.otherFees)
                      ? property.otherFees.join(", ")
                      : property.otherFees}
                  </div>
                </div>
              )}
                  ...
                  >
                    ...
                    >
                      <Droplet
                        size={18}
                        style={{
                          color: property.utilities.water ? "#00A79D" : "#CCC",
                        }}
                      />
                    ...
                    >
                      <Wind
                        size={18}
                        style={{
                          color: property.utilities.gas ? "#00A79D" : "#CCC",
                        }}
                      />
                      <span style={{ fontSize: "14px", color: "#333333" }}>
                    ...
                    >
                      <Zap
                        size={18}
                        style={{
                          color: property.utilities.electric
                            ? "#00A79D"
                            : "#CCC",
                        }}
                      />
                      <span style={{ fontSize: "14px", color: "#333333" }}>
                        Electric {property.utilities.electric ? "✓" : "✗"}
                      </span>
                    </div>
                  </div>
                  {property.utilities.included &&
                    property.utilities.included.length > 0 && (
                      ...
                      >
                        ...
                        {property.utilities.included.join(", ")}
                      </div>
                    )}
                  {property.utilities.tenantPays &&
                    property.utilities.tenantPays.length > 0 && (
                      <div style={{ fontSize: "14px", color: "#333333" }}>
                        <strong>Tenant Pays:</strong>{" "}
                        {property.utilities.tenantPays.join(", ")}
                      </div>
                    )}
                </div>
              )}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  9654131789 support@ggnhome.com
                </span>
              </div>
              {/* <button
                style={{
