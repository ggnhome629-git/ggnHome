...
export default function PropertyCardsAgent() {
  ...
  // --- AGENT TOKEN: for protected APIs (incognito/cookie-off) ---
  ...
  // Helper: Get property share link (Rentaldetails/Saledetails)
  const getPropertyShareLink = (property) => {
    const base = window.location.origin;
    const type = (property.defaultPropertyType || "").toLowerCase();
    if (type === "rental") return `${base}/Rentaldetails/${property._id}`;
    return `${base}/Saledetails/${property._id}`;
  };
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            {/* --- Share Link for Client (bold, highlighted block) --- */}
                            {p.isActive && (
                              <div
                                style={{
                                  marginTop: "8px",
                              ...
                              >
                                ...
                                <span
                                  onClick={() => {
                                    const link = getPropertyShareLink(p);
                                ...
                                >
                                  Click here to copy property link
                                </span>
                              </div>
                            )}
                            ...
                            >
                              ...
                              <button
                                onClick={async (e) => {
                                  ...
                                  try {
                                    ...
                                    navigate(`/agent/property-analytics/${p._id}`, {
                              ...
                              <button
                                onClick={(e) => {
                                  ...
                                  if (t === "rental") {
                                    navigate(`/agent/rentaldetails/${p._id}`, { state: { preview: true } });
                                  } else if (t === "sale") {
                                    navigate(`/agent/saledetails/${p._id}`, { state: { preview: true } });
                                  } else {
                                    navigate(`/agent/rentaldetails/${p._id}`, { state: { preview: true } });
                                  }
                                }}
                              ...
                              {/* --- Share Property Button (highlighted, after View Details) --- */}
                              {p.isActive && (
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    const link = getPropertyShareLink(p);
                                    navigator.clipboard.writeText(link);
                                    alert("Property link copied. Share it with your client!");
                                  }}
                                  style={{
