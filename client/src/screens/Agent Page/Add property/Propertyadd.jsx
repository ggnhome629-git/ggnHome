...
export default function PropertyListingForm() {
  // --- Hybrid auth support: get agent token from localStorage (for incognito/cookie-off) ---
...
floorForRent: "",
  ...
  const { agent, fetchAgent } = useAgentAuth();
...
if (formData.purpose === "Rent" && skippedFields.has(key)) return;
   ...
   const url =
        formData.purpose === "Sale"
          ? `${process.env.REACT_APP_Base_API}/api/agent/addsaleproperties`
          : `${process.env.REACT_APP_Base_API}/api/agent/addrentproperties`;
