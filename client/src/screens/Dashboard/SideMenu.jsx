      ...
      >
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 24px', borderBottom: '1px solid #E5E7EB', backgroundColor: '#F4F7F9'}}>
          <div style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
            ...
            >
              {currentUser
                ? `Welcome ${currentUser.mobileNumber || currentUser.email || ''}`
                : 'Welcome Guest'}
            </span>
          </div>
...
>
        ...
        {/* Footer */}
        <div style={{position: 'sticky', bottom: '0', left: '0', right: '0', padding: '20px', backgroundColor: '#F4F7F9', borderTop: '1px solid #E5E7EB', zIndex: 10}}>
          ...
          <div style={{fontSize: '13px', color: '#333333', textAlign: 'center', lineHeight: '1.6'}}>
            <strong> Call us on 9654131789 .</strong><br/>
