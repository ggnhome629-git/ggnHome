...
const dismissPrefPopup = (durationMs = 10 * 60 * 1000) => {
  ...
  // Scroll-aware navbar: after a small threshold, tighten padding and add a
  // touch more shadow/opacity. Kept subtle per design-system guidance — the
  // navbar should never jump or move aggressively.
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_Base_API}/auth/change-password-direct`,
        {
          method: "POST",
          credentials: "include",
          headers: {
        ...
        >
          ...
          <div
            onClick={() => {
              ...
              // Flatmates routes → always redirect to flatmatesdashboard
              const flatmatesPaths = [
                "/flatmatesdashboard",
                "/flatmatessearch",
                "/flatmatesearchpropertymodal",
                "/flatmateslistingform",
              ...
              if (flatmatesPaths.some((p) => path.startsWith(p))) {
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <div
              style={{
                ...
                textOverflow: "ellipsis",
                maxWidth:
                  density === "icon" ? "0px" : isSmallScreen ? "24px" : "120px",
              }}
            >
              {user 
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              {/* <div>
                <h3 style={{ margin: 0, color: "#003366", fontWeight: 800 }}>
                  Change Password
                </h3>
                <p style={{ margin: 0, fontSize: "0.8rem", color: "#4A6A8A" }}>
            ...
            {user  && (
              <input
                type="email"
                placeholder="Change Your Email ID (optional)"
                value={recoveryEmail}
            ...
            <button
              ...
              disabled={updatingPassword || emailSaving}
              style={{
                marginTop: 6,
                width: "100%",
                padding: "12px",
            ...
            >
              {updatingPassword || emailSaving ? "Saving..." : "Update Email"}
            </button>
          </div>
        </div>
      )}
